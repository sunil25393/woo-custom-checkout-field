                           ...
                           foreach ($array_fields as $value) {
                                  ...
                                  <tr valign="top">
                                      ...
                                      <td class="forminp forminp-select  " width="8%">
                                          <label>
                                              <?php echo (in_array($all[$value]['id'], $ccf_enable)) ? '<a  href="' . esc_url(menu_page_url("ccf_settings_menu", false) . '&ds=' . $all[$value]['id']) . '" title="Disable it"><span class="dashicons dashicons-yes"></span></a>' : '<a  href="' . menu_page_url("ccf_settings_menu", false) . '&en=' . $all[$value]['id'] . '"  title="Enable it"><span class="dashicons dashicons-no"></span></a>'; ?></a></label>
                                      </td>
                                      <td class="forminp forminp-select action">
                                          <label><a href="<?php echo esc_url(current_page_url() . "&edit=" . $all[$value]['id']); ?>"><span class="dashicons dashicons-edit"></span></a><a href="<?php echo esc_url(current_page_url() . "&del=" . $all[$value]['id']); ?>"><span class="dashicons dashicons-trash"></span></a></label>
                                      </td>
                                  </tr>
                                  <?php
                                  $i++;
