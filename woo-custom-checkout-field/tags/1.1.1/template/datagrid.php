                ...
                if (!empty($all)) {
                       foreach ($all as $value) {
                              ...
                              <tr valign="top">
                                  ...
                                  <td class="forminp forminp-select">
                                      <label><?php echo ($value['field_includeemail'] == '1') ? 'true' : 'false'; ?> </label>
                                  </td>
                                  <td class="forminp forminp-select">
                                      <label><a href="<?php echo current_page_url() . "&edit=" . $value['id']; ?>"><span class="edit_icon"></span></a><a href="<?php echo current_page_url() . "&del=" . $value['id']; ?>"><span class="delete_icon"></span></a> </label>
                                  </td>
                              </tr>
                              <?php
                       }
