                           ...
                           foreach ($array_fields as $value) {
                                  ...
                                  <tr valign="top">
                                      <td class="sort ui-sortable-handle">
                                          <input type="hidden" name="f_order[<?php echo $all[$value]['id']; ?>]" class="f_order" value="<?php echo $i; ?>">
                                      </td>
                                      <!--<td class="td_select"><input type="checkbox" name="select_field"/></td>-->
                                      <td scope="row" class="titledesc">
                                          <label><?php echo $all[$value]['field_name']; ?> </label>
                                      </td>
                                      <td class="forminp forminp-select">
                                          <label><?php echo $all[$value]['field_class']; ?> </label>
                                      </td>
                                      <td class="forminp forminp-select">
                                          <label><?php echo $all[$value]['field_type']; ?> </label>
                                      </td>
                                      <td class="forminp forminp-select">
                                      ...
                                      <td class="forminp forminp-select  " width="8%">
                                          <label>
                                              <?php echo (in_array($all[$value]['id'], $ccf_enable)) ? '<a  href="' . menu_page_url("ccf_settings_menu", false) . '&ds=' . $all[$value]['id'] . '" title="Disable it"><span class="dashicons dashicons-yes"></span></a>' : '<a  href="' . menu_page_url("ccf_settings_menu", false) . '&en=' . $all[$value]['id'] . '"  title="Enable it"><span class="dashicons dashicons-no"></span></a>'; ?></a></label>
                                      </td>
                                      <td class="forminp forminp-select action">
                                          <label><a href="<?php echo current_page_url() . "&edit=" . $all[$value]['id']; ?>"><span class="dashicons dashicons-edit"></span></a><a href="<?php echo current_page_url() . "&del=" . $all[$value]['id']; ?>"><span class="dashicons dashicons-trash"></span></a></label>
                                      </td>
                                  </tr>
                                  <?php
                                  $i++;
