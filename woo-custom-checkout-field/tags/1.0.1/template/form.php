...
<!--            <small><b>Note: </b>&nbsp;Id should one unique word. It does not contain any soacial chare except "_". <br>Fox Example: my_custom_field_id</small>-->
        ...
        <div class="form-group">        
            <div class="col-sm-offset-4 col-sm-10">
                <div class="checkbox">
                    <label><input type="checkbox" name="txt_field_required"> Required field</label>
                </div>
            </div>
        </div>
        <div class="form-group">        
            <div class="col-sm-offset-4 col-sm-10">
                <div class="checkbox">
                    <label><input type="checkbox" name="txt_field_add_email"> Include in order invoice </label>
                </div>
            </div>
        </div>
        <div class="form-group">        
